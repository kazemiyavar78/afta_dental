...
// Handler کنترلر HTTP ماژول ضوابط.
type Handler struct{ service *Service }

// NewHandler نمونه Handler ضوابط می‌سازد.
func NewHandler(s *Service) *Handler { return &Handler{service: s} }

// Create ضابطه جدید ایجاد می‌کند.
...
// GetByID ضابطه را با شناسه برمی‌گرداند.
...
// List لیست ضوابط را برمی‌گرداند.
